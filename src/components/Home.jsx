...
ShoppingCartIcon;
import boyreadingAnimation from "../assets/boyreading.json";
const Home = () => {
  return (
    <div className="my-container flex flex-col items-center justify-between lg:flex-row container container-md mx-auto ">
      {/* Left Desc */}
        ...
        <div className="flex flex-col items-center md:flex-row">
          <Link to="/books" className="btn md:w-auto md:mr-4">
            <div className="inline-flex items-center justify-center w-full h-full">
              <p className="mr-3 inline-flex items-center h-12 px-6 mb-3 font-medium text-white transition duration-200 rounded shadow-md md:mb-0 bg-blue-400 hover:bg-blue-700">
                Visit Store
              </p>
              <ShoppingCartIcon className="w-5 text-gray-300" />
            </div>
          </Link>
          <Link
            to="/about"
      ...
      <div className="relative lg:w-1/2 ">
        <div className="w-full lg:w-4/5 lg:ml-auto h-56  sm:h-96">
          <Lottie animationData={boyreadingAnimation} loop={true} />
        </div>
      </div>
    </div>
  );
